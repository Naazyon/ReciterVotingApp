...
def vote(chapter):
    if(request.form):
        ...
        db.session.commit()
    currentChapter = chapters[chapter-1]
    return render_template('vote.html', title="Vote - QRVA", chapter = currentChapter)
